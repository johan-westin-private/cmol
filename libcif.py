...
def MainreportEN(html, cif):
    ...
    if cif["_symmetry_space_group_name_H-M"].upper() in ["P 21", "P21"]:
        ...
        html.element("p",
                     "Based on the statistical distribution of the intensities, a centrosymetric structure is deduced.")
    elif cif["_symmetry_space_group_name_H-M"].upper() in ["P1", "P 1"]:
        html.element("p",
                     "Based on the statistical distribution of the intensities, a non centrosymetric structure is deduced.")
    else:
