...
def MainreportFR(html,cif):
	...
	html.start("p")
	html.data("\nUn monocristal sйlectionnй optiquement sous microscope binoculaire a йtй placй sur la tкte goniomйtrique d'un diffractomиtre %s"%(cif["_diffrn_measurement_device_type"]))
	try:
	...
	html.data(" Une recherche systйmatique de noeuds de diffraction indique que le cristal appartient au systиme %sque avec les paramиtres de maille suivants :\n"%cif["_symmetry_cell_setting"].lower()[:-1])
	html.end("p")
	html.start("center")
